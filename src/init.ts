...
export const cfg = new AppConfig({
    ...
    SAFE_HAVEN_AUTH_TOKEN: process.env.SAFE_HAVEN_AUTH_TOKEN,
    SAFE_HAVEN_REFRESH_TOKEN: process.env.SAFE_HAVEN_REFRESH_TOKEN,
    LOG_LEVEL: process.env.LOG_LEVEL || 'info',
    OYEAH_MAIN_ACCOUNT_SAFEHAVEN: process.env.OYEAH_MAIN_ACCOUNT_SAFEHAVEN,
    OYEAH_ESCROW_ACCOUNT_SAFEHAVEN: process.env.OYEAH_ESCROW_ACCOUNT_SAFEHAVEN,
    OYEAH_ADS_REVENUE_ACCOUNT_SAFEHAVEN: process.env.OYEAH_ADS_REVENUE_ACCOUNT_SAFEHAVEN,
    OYEAH_SERVER_URL: process.env.OYEAH_SERVER_URL,
